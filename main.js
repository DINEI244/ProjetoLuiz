function getProjects() {
  const urlGitHub = "https://api.github.com/users/DINEI244/repos"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/DINEI244?tab=repositories"]; // Link para o repositório no GitHub
    a.target = "_blank";
    a.title = repo["description"] || "Repositório no GitHub";
    a.textContent = repo["Luiz"];
